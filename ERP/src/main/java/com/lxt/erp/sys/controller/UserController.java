...
import com.lxt.erp.sys.common.PinyinUtils;
...
import com.lxt.erp.sys.vo.UserVo;
...
public class UserController {
    ...
    public ResultObj addUser(UserVo userVo){
        try {
            ...
            userVo.setPwd(new Md5Hash(Constast.USER_DEFAULT_TWD,salt,2).toString());//设置密码
    ...
    public ResultObj resetPwd(Integer id){
        try {
            ...
            user.setPwd(new Md5Hash(Constast.USER_DEFAULT_TWD,salt,2).toString());//设置密码
